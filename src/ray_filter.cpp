...
RayFilterGroundSegmentation::RayFilterGroundSegmentation(pcl::PointCloud<pcl::PointXYZI>::Ptr incloud)
{
    cloud_in_ptr_.reset(new pcl::PointCloud<pcl::PointXYZI>);
    *cloud_in_ptr_ = *incloud;
}

RayFilterGroundSegmentation::~RayFilterGroundSegmentation() {}

void RayFilterGroundSegmentation::clip_above(double clip_height, const pcl::PointCloud<pcl::PointXYZI>::Ptr in,
                             pcl::PointCloud<pcl::PointXYZI>::Ptr out)
{
    ...
    std::cout << in->points.size() << std::endl;
...
void RayFilterGroundSegmentation::remove_close_pt(double min_distance, const pcl::PointCloud<pcl::PointXYZI>::Ptr in,
 ...
 */
void RayFilterGroundSegmentation::XYZI_to_RTZColor(const pcl::PointCloud<pcl::PointXYZI>::Ptr in_cloud,
 ...
 */
void RayFilterGroundSegmentation::classify_pc(std::vector<PointCloudXYZIRTColor> &in_radial_ordered_clouds,
...
void RayFilterGroundSegmentation::point_cb(const sensor_msgs::PointCloud2ConstPtr &in_cloud_ptr)
{
...
void RayFilterGroundSegmentation::process(pcl::PointCloud<pcl::PointXYZI>::Ptr groundpoints, pcl::PointCloud<pcl::PointXYZI>::Ptr non_groundpoints)
{
    {
    // pcl::PointCloud<pcl::PointXYZI>::Ptr current_pc_ptr(new pcl::PointCloud<pcl::PointXYZI>);
    pcl::PointCloud<pcl::PointXYZI>::Ptr cliped_pc_ptr(new pcl::PointCloud<pcl::PointXYZI>);
    ...
    // clip_above(CLIP_HEIGHT, current_pc_ptr, cliped_pc_ptr);
    clip_above(CLIP_HEIGHT, cloud_in_ptr_, cliped_pc_ptr);
    pcl::PointCloud<pcl::PointXYZI>::Ptr remove_close(new pcl::PointCloud<pcl::PointXYZI>);
    ...
    *groundpoints = *ground_cloud_ptr;
    *non_groundpoints = *no_ground_cloud_ptr;
