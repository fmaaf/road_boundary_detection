...
#define local_max_slope_ 5   //max slope of the ground between points, degree             default 8
#define general_max_slope_ 3 //max slope of the ground in entire point cloud, degree      default 5
#define reclass_distance_threshold_ 0.2

class RayFilterGroundSegmentation
{


public:
  RayFilterGroundSegmentation(pcl::PointCloud<pcl::PointXYZI>::Ptr incloud);
  
  ~RayFilterGroundSegmentation();

  void process(pcl::PointCloud<pcl::PointXYZI>::Ptr groundpoints, pcl::PointCloud<pcl::PointXYZI>::Ptr non_groundpoints);

private:
  
  pcl::PointCloud<pcl::PointXYZI>::Ptr cloud_in_ptr_;
  ...
  void clip_above(double clip_height, const pcl::PointCloud<pcl::PointXYZI>::Ptr in, pcl::PointCloud<pcl::PointXYZI>::Ptr out);
